...
namespace api_filmes_senai.Context
{
    public class EventoContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=NOTE44-S28\\SQLEXPRESS; Database = Projeto_EventPLUS; User Id = sa; Pwd = Senai@134; TrustServerCertificate=true;");
            }
        }

        internal void Atualizar(TipoEvento tipoEvento)
        {
